...
public class KiteConnectServiceImp implements KiteConnectService{
    ...
    public String getLoginURL() {
        return kiteConnectConfiguration.getLoginURL();
    }
    ...
    public KiteConnect getKiteConnectInstance() {
        return kiteConnectConfiguration.getKiteConnectInstance();
    }
    ...
    @Override
    public List<com.investing.algoTrading.Tradex.model.Position> getPositions() {
        try {
            KiteConnect kiteConnect = kiteConnectConfiguration.getKiteConnectInstance();
